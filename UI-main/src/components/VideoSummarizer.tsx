...
const VideoSummarizer: React.FC<VideoSummarizerProps> = ({ onClose, onFeatureSelect, autoSpaceKey, isSpaceAutoConnected, onModeSelect }) => {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-100/90">Summarize and analyze videos in your Confluence workspace</p>
              </div>
            </div>
